...
[ApiController]
public class WorkingHoursController : ControllerBase, ICrudController<WorkingHour, WorkingHourCreateDTO, WorkingHourUpdateDTO>
{
    private readonly IWorkingHourService Service;
    private readonly IMapper Mapper;

    public WorkingHoursController(IWorkingHourService service, IMapper mapper)
    {
        Service = service;
        Mapper = mapper;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] WorkingHourCreateDTO value)
    {
        var model = Mapper.Map<WorkingHour>(value);
        var result = await Service.CreateAsync(model);
        return Ok(result);
    }

    [HttpPost("batch")]
    public async Task<IActionResult> Create([FromBody] ICollection<WorkingHourCreateDTO> values)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] WorkingHourUpdateDTO value)
    {
