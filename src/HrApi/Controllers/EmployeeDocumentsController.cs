...
[ApiController]
public class EmployeeDocumentsController : ControllerBase, ICrudController<EmployeeDocument, EmployeeDocumentCreateDTO, EmployeeDocumentUpdateDTO>
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeDocumentCreateDTO value)
    {
        var model = Mapper.Map<EmployeeDocument>(value);
        var result = await Service.CreateAsync(model);
        return Ok(result);
    }

    [HttpPost("batch")]
    public async Task<IActionResult> Create([FromBody] ICollection<EmployeeDocumentCreateDTO> values)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] EmployeeDocumentUpdateDTO value)
    {
