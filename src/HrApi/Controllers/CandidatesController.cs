...
[ApiController]
public class CandidatesController : ControllerBase, ICrudController<Candidate, CandidateCreateDTO, CandidateUpdateDTO>
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CandidateCreateDTO value)
    {
        var model = Mapper.Map<Candidate>(value);
        var result = await Service.CreateAsync(model);
        return Ok(result);
    }

    [HttpPost("batch")]
    public async Task<IActionResult> Create([FromBody] ICollection<CandidateCreateDTO> values)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] CandidateUpdateDTO value)
    {
